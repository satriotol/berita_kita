            ...
            <div class="owl-slider owl-carousel">
                <div class="item">
                    <div class="owl-slider-item">
                        <img src="upload/<?=$slide_gbr["slide_gambar"]; ?>" class="img-responsive" alt="portfolio">
                ...
                <div class="item">
                    <div class="owl-slider-item">
                        <img src="upload/<?=$slide_gbr2["slide_gambar"]; ?>" class="img-responsive" alt="portfolio">
                        <div class="intro-text">
                ...
                <div class="item">
                    <div class="owl-slider-item">
                        <img src="upload/<?= $slide_gbr3["slide_gambar"]; ?>" class="img-responsive" alt="portfolio">
                        <div class="intro-text">
                ...
                <div class="item">
                    <div class="owl-slider-item">
                        <img src="upload/<?= $slide_gbr4["slide_gambar"]; ?>" class="img-responsive" alt="portfolio">
                        <div class="intro-text">
