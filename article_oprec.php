...
$jumlahData = count(query("SELECT * FROM berita WHERE kategori = 'OPREC' "));
$jumlahHalaman = ceil($jumlahData / $jumlahDataPerHalaman);
$halamanAktif = (isset($_GET["halaman"])) ? $_GET["halaman"] : 1;
$awalData = ($jumlahDataPerHalaman * $halamanAktif) -$jumlahDataPerHalaman;
$index = query("SELECT * FROM berita WHERE kategori = 'OPREC' ORDER BY id DESC");
...
<body id="page-top">
    ...
    <header>
    <?php
        include 'slide/slide_oprec.php';
    ?>
    </header>
    <div class="container-wrapper">
        <div class="main-page-header">
            <h1 class="main-page-title">OPREC</h1>
        </div>
        <div class="pendahuluan">
            ...
            <div class="pendahuluan-article">
                <h5 class="pendahuluan-article-title">OPREC</h5>
