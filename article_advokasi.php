...
$jumlahData = count(query("SELECT * FROM berita WHERE kategori = 'ADVOKASI' "));
$jumlahHalaman = ceil($jumlahData / $jumlahDataPerHalaman);
$halamanAktif = (isset($_GET["halaman"])) ? $_GET["halaman"] : 1;
$awalData = ($jumlahDataPerHalaman * $halamanAktif) -$jumlahDataPerHalaman;
$index = query("SELECT * FROM berita WHERE kategori = 'ADVOKASI' ORDER BY id DESC");
...
<body id="page-top">
    ...
    <header>
    <?php
        include 'slide/slide_advokasi.php';
    ?>
    </header>
    <div class="container-wrapper">
        <div class="main-page-header">
            <h1 class="main-page-title">ADVOKASI</h1>
        </div>
        <div class="pendahuluan">
            ...
            <div class="pendahuluan-article">
                <h5 class="pendahuluan-article-title">ADVOKASI</h5>
