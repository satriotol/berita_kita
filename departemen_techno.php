...
$jumlahData = count(query("SELECT * FROM berita WHERE kategori = 'TECHNO'"));
$jumlahHalaman = ceil($jumlahData / $jumlahDataPerHalaman);
$halamanAktif = (isset($_GET["halaman"])) ? $_GET["halaman"] : 1;
$awalData = ($jumlahDataPerHalaman * $halamanAktif) -$jumlahDataPerHalaman;
$index = query("SELECT * FROM berita WHERE kategori = 'TECHNO'  ORDER BY id DESC ");
...
<body id="page-top">
    ...
    <header>
    <?php
        include 'slide/slide_techno.php';
    ?>
    </header>
    <div class="container-wrapper">
        <div class="main-page-header">
            <h1 class="main-page-title">TECHNO</h1>
        </div>
        <div class="pendahuluan">
            <div class="pendahuluan-img">
                <img width="100" src="images/departemen/TECHNO.png" alt="">
            </div>
            <div class="pendahuluan-article">
                <h5 class="pendahuluan-article-title">TECHNO</h5>
