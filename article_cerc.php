...
$jumlahData = count(query("SELECT * FROM berita WHERE kategori = 'CERC' "));
$jumlahHalaman = ceil($jumlahData / $jumlahDataPerHalaman);
$halamanAktif = (isset($_GET["halaman"])) ? $_GET["halaman"] : 1;
$awalData = ($jumlahDataPerHalaman * $halamanAktif) -$jumlahDataPerHalaman;
$index = query("SELECT * FROM berita WHERE kategori = 'CERC' ORDER BY id DESC");
...
<body id="page-top">
    ...
    <header>
    <?php
        include 'slide/slide_cerc.php';
    ?>
    </header>
    <div class="container-wrapper">
        <div class="main-page-header">
            <h1 class="main-page-title">CERC</h1>
        </div>
        <div class="pendahuluan">
            ...
            <div class="pendahuluan-article">
                <h5 class="pendahuluan-article-title">CERC</h5>
