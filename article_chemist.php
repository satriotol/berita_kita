...
$jumlahData = count(query("SELECT * FROM berita WHERE kategori = 'CHEMIST' "));
$jumlahHalaman = ceil($jumlahData / $jumlahDataPerHalaman);
$halamanAktif = (isset($_GET["halaman"])) ? $_GET["halaman"] : 1;
$awalData = ($jumlahDataPerHalaman * $halamanAktif) -$jumlahDataPerHalaman;
$index = query("SELECT * FROM berita WHERE kategori = 'CHEMIST' ORDER BY id DESC");
...
<body id="page-top">
    ...
    <header>
    <?php
        include 'slide/slide_chemist.php';
    ?>
    </header>
    <div class="container-wrapper">
        <div class="main-page-header">
            <h1 class="main-page-title">CHEMIST</h1>
        </div>
        <div class="pendahuluan">
            ...
            <div class="pendahuluan-article">
                <h5 class="pendahuluan-article-title">CHEMIST</h5>
