...
$jumlahData = count(query("SELECT * FROM berita WHERE kategori = 'GA'"));
$jumlahHalaman = ceil($jumlahData / $jumlahDataPerHalaman);
$halamanAktif = (isset($_GET["halaman"])) ? $_GET["halaman"] : 1;
$awalData = ($jumlahDataPerHalaman * $halamanAktif) -$jumlahDataPerHalaman;
$index = query("SELECT * FROM berita WHERE kategori = 'GA'  ORDER BY id DESC ");
...
<body id="page-top">
    ...
    <header>
    <?php
        include 'slide/slide_ga.php';
    ?>
    </header>
    <div class="container-wrapper">
        <div class="main-page-header">
            <h1 class="main-page-title">GA</h1>
        </div>
        <div class="pendahuluan">
            <div class="pendahuluan-img">
                <!-- <img width="100" src="images/departemen/GA.png" alt=""> -->
            </div>
            <div class="pendahuluan-article">
                <h5 class="pendahuluan-article-title">GA</h5>
